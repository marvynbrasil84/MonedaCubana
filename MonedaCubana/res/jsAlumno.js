...
$("#btnCrear").click(function () {
    ...
    var telfPadre = $("#Telefono_Padre").val();
    var nombreMadre = $("#Nombre_Madre").val();
    var telfMadre = $("#Telefono_Madre").val();
    ...
    var alumno = {
        ...
        Direccion: Direccion, Correo: Correo, Nombre_Padre: nombrePadre,
        Telefono_Padre: telfPadre, Nombre_Madre: nombreMadre, Telefono_Madre: telfMadre ,Raza: Raza,
        Primer_Apellido: Primer_Apellido, Segundo_Apellido: Segundo_Apellido,
        Provincia: Provincia, Municipio: Municipio, Fecha_Inicio_Contrato: FIC, Fecha_Fin_Contrato: FFC, Numero_Contrato: NC,
        categoria: categoria, Foto: foto, NombreGrupo: NombreGrupo
    };
